 ...
 */
export function GlobalNav({ items }: { items: Item[] }) {
  return (
    <header className="sticky top-0 z-50 bg-tile-black">
      ...
      >
        <Link href="/" aria-label="9ent — Trang chủ" className="shrink-0">
          <Logo tone="ondark" className="h-4 w-auto" />
        </Link>
